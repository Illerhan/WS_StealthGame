...
%DXC% -HV 2021 /auto-binding-space 0 /Zpr /O3 -Wno-parentheses-equality -disable-lifetime-markers /T cs_6_6 /E VisualizeQuadsCS /Fc LumenVisualize.d3dasm /Fo LumenVisualize.dxil LumenVisualize.usf
:END
PAUSE
